  ...
  Widget build(BuildContext context) {
    return //SafeArea(
      ...
      children: [
        ...
        Container(
          color: const Color.fromARGB(255, 5, 101, 179),
          ...
          child: TextField(
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor: const Color.fromARGB(255, 20, 68, 100),
            ...
            Container(
              ...
              child: RichText(
                ...
                TextSpan(
                  text: 'WITHIN',
                  style: TextStyle(
                      color: Colors.white, fontFamily: 'Manrope', fontSize: 11),
                ),
                TextSpan(
                  text: '\n1 Hour',
                  style: TextStyle(
                      color: Colors.white, fontFamily: 'Manrope', fontSize: 14),
                ),
                WidgetSpan(
                  child: Icon(
